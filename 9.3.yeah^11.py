...
# odtworzenie tabeli rozmieszczenia ludzi
pole = [['' for x in range(X)] for y in range(Y)]
for y in range(Y):
    for x in range(X):
        for lp in range(L):
...
while(wszyscy_na_miejscu_lol!='prawda'):
    ...
    for i in range(L):
        tabela_wektorow[i][0] = tabela_wspolrzednych_ludzi[tabela_wyboru[i][1] - 1][1] - 1 - (tabela_wspolrzednych_ludzi[i][1] - 1 - 1) # przesunięcie w osi X - 1
        tabela_wektorow[i][1] = tabela_wspolrzednych_ludzi[tabela_wyboru[i][1] - 1][2] - 1 - (tabela_wspolrzednych_ludzi[i][2] - 1 - 1) # przesunięcie w osi Y - 1
        ...
        if(tabela_wspolrzednych_ludzi[tabela_wyboru[i][1] - 1][1]-2 < tabela_wspolrzednych_ludzi[i][1] < tabela_wspolrzednych_ludzi[tabela_wyboru[i][1] - 1][1]+2):
            ...
            if(wszyscy_na_miejscu[i]=='falsz'):
                ...
                if(tabela_wspolrzednych_ludzi[i][1]<1):
                    tabela_wspolrzednych_ludzi[i][1] = tabela_wspolrzednych_ludzi[i][1]+1
                if(tabela_wspolrzednych_ludzi[i][1] > X):
                    tabela_wspolrzednych_ludzi[i][1] = tabela_wspolrzednych_ludzi[i][1]-1
        else:
            wszyscy_na_miejscu[i]='falsz'
        ...
        if (tabela_wspolrzednych_ludzi[tabela_wyboru[i][1] - 1][2]-2 < tabela_wspolrzednych_ludzi[i][2] < tabela_wspolrzednych_ludzi[tabela_wyboru[i][1] - 1][2]+2):
            ...
            if(wszyscy_na_miejscu[i]=='falsz'):
                ...
                if(tabela_wspolrzednych_ludzi[i][2]<1):
                    tabela_wspolrzednych_ludzi[i][2] = tabela_wspolrzednych_ludzi[i][1]+1
                if(tabela_wspolrzednych_ludzi[i][2] > Y):
                    tabela_wspolrzednych_ludzi[i][2] = tabela_wspolrzednych_ludzi[i][1]-1
        else:
            wszyscy_na_miejscu[i]='falsz'
